        ...
        <div className='container mt-5'>
            <div className='row'>
                ...
                <div className='col-4 mt-5'>
                    <h4 className='fs-5'><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Account Opening</h4>
                    <div className='mt-5'>
                ...
                <div className='col-4 mt-5'> <h4 className='fs-5'><i class="fa-solid fa-user me-2"></i>Your Zerodha Account</h4>
                    <div className='mt-5'>
                ...
                <div className='col-4 mt-5'><h4> <i class="fa-solid fa-chart-column me-2"></i>Your Zerodha Account</h4>
                    <div className='mt-5'>
            ...
            <div className='row'>
                <div className='col-4 mt-5'>
                    <h4 className='fs-5'><i class="fa-solid fa-wallet me-2"></i>Funds</h4>
                    <div className='mt-5'>
                ...
                <div className='col-4 mt-5'> <h4 className='fs-5'><i class="fa-brands fa-connectdevelop me-2"></i>Console</h4>
                    <div className='mt-5'>
                ...
                <div className='col-4 mt-5'><h4><i class="fa-solid fa-coins me-2"></i>Coin</h4>
                    <div className='mt-5'>
